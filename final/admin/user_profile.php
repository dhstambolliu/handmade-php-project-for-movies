...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location: /projekt/finali/php/login.php");
    exit;
}
        ...
        <div class="container-fluid">
            <div class="col-xl-2 sidebar fixed-top" id="myDIV">
              ...
              <ul class="navbar-nav flex-column mt-4">
                <li class="nav-item"><a href="user_profile.php" class="nav-link text-white p-3 mb-2 btnnn active"><i class="fas fa-user"></i> Profile</a></li>
