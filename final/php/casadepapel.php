...
<?php
   ...
   $query_afisho = "SELECT * FROM movies WHERE image LIKE 'la%casa%de%papel%'";
      ...
      <div class="content">
         <div>
            ...
            <table class="a gfg">
               ...
               <td class="geeks">
                  <table class="a">
                     <tr><b style="font-size:17px"><?php echo $row["image_text"]; ?></b><br><b>La Casa De Papel</b> (<?php echo $row['year'];?>)
                  </table>
                  <table>
                     <tr>
                        <td class="geeks">
