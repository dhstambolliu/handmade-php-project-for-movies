...
<?php
   ...
   $validation = array();
   if (empty($validation)) {
   $query_afisho = "SELECT * FROM movies WHERE image_text LIKE '%$search%'";
...
<html>
   ...
   <body>
      ...
      <?php
         if ($check_num_rows == 0) {
         echo "<p style='color:red; font-size: 20px'>Nuk ka te dhena per: <b>'$search'</b></p>";
         }else{
         echo "<p style='color:black; font-size: 20px'>Results searched for: <b>'$search'</b></p>";
         }
         ?>
      <div class="content">
         <div>
            ...
            <table class="a gfg">
               ...
               <td class="geeks">
                  ...
                  <table>
                     <tr>
                        <td class="geeks">
                           <div class="dropdown"><button class="dropbtn"><a href="<?php echo 'Filma/'.$row['video']; ?>" target="_blank"><i class="far fa-eye"></i> Watch</a></button></div>
                        </td>
                        <td>
                           <div class="dropdown"><button class="dropbtn"><a class="bla-1" href="<?php echo $row['link'];?>"><i style="color: red" class="fab fa-youtube"></i>Trailer</a></button></div>
                        </td>
                        <td>
                           <div class="dropdown"><button class="dropbtn" onClick='<?php echo $row['info'];?>'><i style="color: green" class="fas fa-info-circle"></i><a>Info</a></button></div>
                        </td>
                     </tr>
                  </table>
               </td>
