...
$query_afisho = "SELECT * FROM movies WHERE image LIKE '%el%chapo%' ORDER BY id DESC";
...
<?php
        ...
        <table class="a gfg">
            ...
            <td class="geeks">
                <table class="a">
                <tr><b style="font-size:17px"><?php echo $row["image_text"]; ?></b><br><b>El Chapo</b> (<?php echo $row['year'];?>)
                </table>
                <table>
                <tr>
            <td class="geeks">
