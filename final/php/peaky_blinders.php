...
$query_afisho = "SELECT * FROM movies WHERE image LIKE '%peaky%blinders%' ORDER BY id DESC";
...
<?php
        ...
        <table class="a gfg">
            <tr>
                ...
                <div class="imbd">
                <div class="imbd_transform"><p><img src="IMDB_Logo_2016.svg" width="45" height="20"> <?php echo $row["IMBd"]; ?></p></div>
                    </div>
                    </div>
                </td>
            </tr>
            <td class="geeks">
                <table class="a">
                <tr><b style="font-size:17px"><?php echo $row["image_text"]; ?></b><br><b>Peaky Blinders</b> (<?php echo $row['year'];?>)
                </table>
                <table>
                <tr>
            <td class="geeks">
