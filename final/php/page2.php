...
<html>
   ...
   <body>
      ...
      <?php include 'config.php';
         ...
         $query_afisho = "SELECT * FROM movies WHERE genre!='serial' ORDER BY id DESC LIMIT 19,18";
      ...
      <table class="copyright" id="myDIV">
         <tr>
            <td>
               <p style="text-align: center; font-weight: bolder">Faqe <button class="page btnnn"><a href="index.php">1</a></button>
                  <button class="page btnnn active"><a href="page2.php">2</a></button>
                  <button class="page btnnn"><a href="page3.php">3</a></button>
               </p>
            </td>
         </tr>
         <tr>
