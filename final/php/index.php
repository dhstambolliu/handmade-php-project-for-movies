...
<html>
   ...
   <body>
      ...
      <?php
         ...
         $query_afisho = "SELECT * FROM movies WHERE genre!='serial' ORDER BY id DESC LIMIT 0,18";
               ...
               <td class="geeks">
                  ...
                  <table>
                     <tr>
                        <td class="geeks">
                           <div class="dropdown">
                              <button class="dropbtn"><a href="<?php echo 'Filma/'.$row['video']; ?>" target="_blank"><i class="fa fa-play"></i> Watch </a></button>
                           </div>
                        </td>
                        <td>
                           <div class="dropdown">
      ...
      <table class="copyright" id="myDIV">
         <tr>
            <td>
               <p style="text-align: center; font-weight: bolder">Page <button class="page btnnn active"><a href="index.php">1</a></button>
                  <button class="page btnnn"><a href="page2.php">2</a></button>
                  <button class="page"><a href="page3.php">3</a></button>
               </p>
            </td>
         </tr>
         <tr>
